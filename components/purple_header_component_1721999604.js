            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Book Walks-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" :class="[textStylePrimary, hoverTextStylePrimary]" href="Book Walks.html">Book Walks</a></li>
                        <li><a id="Walker Profiles-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Walker Profiles.html" :class="[textStylePrimary, hoverTextStylePrimary]">Walker Profiles</a></li>
                        <li><a id="Doggy Day Care-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Doggy Day Care.html" :class="[textStylePrimary, hoverTextStylePrimary]">Doggy Day Care</a></li>
                        <li><a id="Pet Supplies-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Pet Supplies.html" :class="[textStylePrimary, hoverTextStylePrimary]">Pet Supplies</a></li>
                        <li><a id="My Account-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="My Account.html" :class="[textStylePrimary, hoverTextStylePrimary]">My Account</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            <li><a id="mobile-Book Walks-link" class="flex font-medium text-sm py-1.5" href="Book Walks.html" :class="[textStylePrimary,hoverTextStylePrimary]">Book Walks</a></li>
                            <li><a id="mobile-Walker Profiles-link" class="flex font-medium text-sm py-1.5" href="Walker Profiles.html" :class="[textStylePrimary,hoverTextStylePrimary]">Walker Profiles</a></li>
                            <li><a id="mobile-Doggy Day Care-link" class="flex font-medium text-sm py-1.5" href="Doggy Day Care.html" :class="[textStylePrimary,hoverTextStylePrimary]">Doggy Day Care</a></li>
                            <li><a id="mobile-Pet Supplies-link" class="flex font-medium text-sm py-1.5" href="Pet Supplies.html" :class="[textStylePrimary,hoverTextStylePrimary]">Pet Supplies</a></li>
                            <li><a id="mobile-My Account-link" class="flex font-medium text-sm py-1.5" href="My Account.html" :class="[textStylePrimary,hoverTextStylePrimary]">My Account</a></li>
                        </ul>
                    </nav>
